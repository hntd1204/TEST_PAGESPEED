(function ($) {
    ...
    //         telFormat = /[0-9 -()+]+$/, actionURL = formObj.attr('action'), resultsObj = $('.form-results');
    ...
    //             error = true;
    //             __this.addClass('is-invalid');
    //         } else if (__this.attr('type') == 'date' && (new Date(fieldVal) < new Date(q.getFullYear(), q.getMonth(), q.getDate()))) {
    //             error = true;
    //             __this.addClass('is-invalid');
    //         }
    //     });
    ...
    //                     $('#contact-form').remove();
    //                 }
    //                 resultsObj.removeClass('alert-success').removeClass('alert-danger').removeClass('d-none');
    //                 if (result.success) {
    //                     resultsObj.addClass('alert-success').html(result.message);
    //                 } else {
    //                     $("#contactUsButton").prop("disabled", false);
    //                     resultsObj.addClass('alert-danger').html(result.message);
    //                 }
    //             }
    //         });
    //     }
